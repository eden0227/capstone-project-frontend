...
import { fetchBarbers, fetchScheduleAvailable, createReservation } from "../features/bookings/bookingsSlice";

export default function NewBookingModal({ showBooking, handleCloseBooking }) {
    ...
    return (
        <Modal show={showBooking} onHide={handleCloseBooking} centered style={{ fontFamily: "Genos, cursive", fontSize: "1.2rem" }}>
            <Modal.Header closeButton className="d-flex justify-content-center">
                <Modal.Title className="w-100 text-center">Your Reservation</Modal.Title>
            </Modal.Header>
            <Modal.Body>
                <Form className="p-2 d-flex flex-column" onSubmit={handleSubmit}>
                    ...
                    <Form.Group className="mb-3">
                        ...
                        <Form.Control required type="text" name="phoneNumber" placeholder="Enter your phone number" />
                    </Form.Group>

                    <div className="pt-2 d-flex justify-content-center">
                        <Button variant="dark" type="submit" style={{ width: "60%" }}>Book Now</Button>
                    </div>
                </Form>
            </Modal.Body>
        </Modal>
